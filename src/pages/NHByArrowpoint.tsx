      ...
      <section className="px-4 pt-8 pb-20">
        <div className="max-w-6xl mx-auto">
          <div className="relative rounded-3xl overflow-hidden px-8 py-16 md:py-24 flex flex-col items-center text-center" style={{ background: "#021538" }}>
            ...
            <img src={decorativeCircles} alt="" className="absolute top-36 -right-60 w-[28rem] h-[28rem] opacity-15 pointer-events-none" />
            ...
            {[
              ...
              <div key={item.num} className="flex items-center gap-5 rounded-2xl bg-primary/5 px-6 py-4 w-full max-w-lg">
                <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center shrink-0">
                  {item.icon ? (
                    <img src={item.icon} alt="" className="w-7 h-7" style={{ filter: "brightness(0) saturate(100%) invert(27%) sepia(96%) saturate(4626%) hue-rotate(212deg) brightness(101%) contrast(105%)" }} />
                  ) : (
