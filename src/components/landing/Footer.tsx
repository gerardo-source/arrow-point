          ...
          {/* Logo + Social */}
           <div className="space-y-6">
             <div className="space-y-1">
               <img src={arrowpointLogo} alt="Arrowpoint" className="h-8 [filter:brightness(0)_invert(1)_brightness(1)_sepia(1)_hue-rotate(190deg)_saturate(5)]" style={{ filter: 'brightness(0) invert(1)' }} />
