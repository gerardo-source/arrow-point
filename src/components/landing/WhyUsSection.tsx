  ...
  return (
    <section className="py-14 px-6" id="por-que">
      <div className="mx-auto">
        <div ref={ref} className={`rounded-3xl p-8 md:p-16 lg:p-20 flex flex-col md:grid md:grid-cols-[1fr_1px_1fr] gap-10 md:gap-14 items-stretch overflow-hidden transition-all duration-700 ${isVisible ? "opacity-100 translate-y-0 scale-100" : "opacity-0 translate-y-10 scale-[0.97]"}`} style={{ background: "linear-gradient(135deg, #3888FF, #063D9F)" }}>
          <div className="text-white flex flex-col gap-6">
            <h2 className="text-3xl md:text-5xl font-bold">¿Por qué Nosotros?</h2>
            <div className="w-full h-px bg-white/40" />
            <p className="text-white/80 text-lg md:text-xl leading-relaxed flex-1">
              Conoce los beneficios de crecer con nosotros.
            </p>
            <a href="#contacto" className="inline-flex items-center justify-center gap-2 rounded-lg bg-white text-primary w-full py-3 text-base font-medium hover:bg-white/90 transition-colors mt-auto">
              Habla con equipo
