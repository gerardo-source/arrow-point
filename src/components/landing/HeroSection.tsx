...
const HeroSection = () => {
  return (
    <section className="min-h-screen flex items-center px-6 pt-24 md:pt-4 pb-8">
      <div className="max-w-full mx-auto border-2 border-primary rounded-3xl p-8 md:p-12">
        ...
        <div className="w-full flex items-center justify-center relative order-first md:order-last">
          <img src={circlesBg} alt="" className="absolute w-[200%] h-[200%] object-contain" />
